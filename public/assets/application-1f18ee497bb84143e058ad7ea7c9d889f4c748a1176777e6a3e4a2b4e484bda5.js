...
(function() {
  $(function() {
    var courseDateData, dates, defaultDate, highlightCoursesDates;
    courseDateData = $('table').data('course-date');
    dates = Object.keys(courseDateData || {});
    defaultDate = $('table').data('default-date');
    highlightCoursesDates = function() {
      var d, date, i, j, len, m, ref, results, y;
      results = [];
      for (j = 0, len = dates.length; j < len; j++) {
        ...
        ref = (function() {
          ...
          return results1;
        })(), y = ref[0], m = ref[1], d = ref[2];
        results.push($("[data-month='" + (m - 1) + "'][data-year='" + y + "']").filter(function() {
          return $(this).text() === ("" + d);
    ...
    $('#js_schedule').datepicker({
      ...
      onSelect: function(date, instance) {
        return window.location = window.location.pathname + '?start_date=' + date;
      }
    });
    highlightCoursesDates();
    $(document).on('click', '.ui-datepicker-next, .ui-datepicker-prev', function() {
      return highlightCoursesDates();
    });
