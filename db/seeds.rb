...
station1 = Station.create(name: 'Parkson', location: 'district 10, Ho Chi Minh City')
station2 = Station.create(name: 'Lotteria', location: 'district 5, Ha Noi')
station3 = Station.create(name: 'Diamon', location: 'Da Nang City')
station4 = Station.create(name: 'Gold', location: 'Hoi An')
station5 = Station.create(name: 'KFC', location: '356, Buon Me Thuot')
station6 = Station.create(name: 'New World', location: '256, Ly Thuong Kiet, Daklak')
station7 = Station.create(name: 'Waseco', location: 'district 10, Ho Chi Minh City')
station8 = Station.create(name: 'Marid', location: 'district 5, Ha Noi')
station9 = Station.create(name: 'Chelsea', location: 'Da Nang City')
station10 = Station.create(name: 'Arsenal', location: 'Hoi An')
station11 = Station.create(name: 'Caravelle', location: '356, Buon Me Thuot')
station12 = Station.create(name: 'Majestic', location: '256, Ly Thuong Kiet, Daklak')
...
course1 = Course.create(name: 'Yoga Course', num_slot: 10, 
              ...
              tuition: 100.0, currency: 'usd', kcal: 40)
course2 = Course.create(name: 'Gym Course', num_slot: 20,
              ...
              tuition: 200.0, currency: 'usd', kcal: 60)
course3 = Course.create(name: 'Swim Course', num_slot: 30, 
              ...
              tuition: 300.0, currency: 'usd', kcal: 80)
course4 = Course.create(name: 'Soc Course', num_slot: 40, 
              ...
              tuition: 400.0, currency: 'usd', kcal: 100)
course5 = Course.create(name: 'Spring Yoga', num_slot: 10, 
              ...
              tuition: 500.0, currency: 'usd', kcal: 120)
course6 = Course.create(name: 'Summer Gym', num_slot: 20, 
              ...
              tuition: 600.0, currency: 'usd', kcal: 140)
course7 = Course.create(name: 'Winter Soc', num_slot: 30, 
              ...
              tuition: 700.0, currency: 'usd', kcal: 160)
course8 = Course.create(name: 'City Yoga', num_slot: 40, 
              ...
              tuition: 800.0, currency: 'usd', kcal: 180)
course9 = Course.create(name: 'Oversea Doc', num_slot: 10, 
              ...
              tuition: 900.0, currency: 'usd', kcal: 200)
course10 = Course.create(name: 'Demo Gym', num_slot: 20, 
              ...
              tuition: 150.0, currency: 'usd', kcal: 220)
course11 = Course.create(name: 'Pro Swim', num_slot: 30, 
              ...
              tuition: 160.0, currency: 'usd', kcal: 240)
course12 = Course.create(name: 'Basic Bad', num_slot: 40, 
              ...
              tuition: 170.0, currency: 'usd', kcal: 260)
