...
User.create!(email: 'customer@tone.com', name: 'Customer', password: '12345678', 
...
Course.create(name: 'Yoga Course', num_slot: 10, 
...
Course.create(name: 'Gym Course', num_slot: 20,
...
Course.create(name: 'Swim Course', num_slot: 30, 
...
Course.create(name: 'Soc Course', num_slot: 40, 
...
Course.create(name: 'Spring Yoga', num_slot: 10, 
...
Course.create(name: 'Summer Gym', num_slot: 20, 
